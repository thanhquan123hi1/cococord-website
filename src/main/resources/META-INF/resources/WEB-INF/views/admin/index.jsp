...
<div class="admin-layout">
    ...
    <aside class="admin-sidebar" aria-label="Admin navigation">
        ...
        <div class="admin-user-profile">
            <div class="admin-user-avatar" style="background: var(--admin-surface-accent); display:flex;align-items:center;justify-content:center;color:var(--admin-primary);font-weight:600;">
                AD
            </div>
