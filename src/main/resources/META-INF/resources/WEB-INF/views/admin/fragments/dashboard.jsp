                            ...
                            <div class="resource-stats">
                                <div class="resource-item">
                                    ...
                                    <div class="resource-bar">
                                        <div class="resource-bar-fill danger" data-stat="bannedUsersPercent"
                                            style="width: 5%;"></div>
                                    </div>
                                </div>
                                <div class="resource-item">
                                    ...
                                    <div class="resource-bar">
                                        <div class="resource-bar-fill warning" data-stat="suspendedServersPercent"
                                            style="width: 3%;"></div>
                                    </div>
                                </div>
                                <div class="resource-item">
                                    ...
                                    <div class="resource-bar">
                                        <div class="resource-bar-fill success" data-stat="newServersTodayPercent"
                                            style="width: 10%;"></div>
                                    </div>
                                </div>
                                <div class="resource-item">
                                    ...
                                    <div class="resource-bar">
                                        <div class="resource-bar-fill primary" data-stat="activeUsers24hPercent"
                                            style="width: 65%;"></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="admin-panel white" id="recent-activity-panel">
                        ...
                        <div class="activity-footer">
                            <a href="${pageContext.request.contextPath}/admin/audit" class="btn btn-ghost btn-sm">Xem
                                tất cả</a>
                        </div>
                    </div>
                    ...
                    <div class="admin-panel white" id="top-servers-panel">
                        <div class="section-title">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/servers" class="btn btn-ghost btn-sm">Xem
                                tất cả</a>
                        </div>
