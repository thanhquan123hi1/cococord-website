<%@ page contentType="text/html;charset=UTF-8" language="java" %> <%-- Chat Page - Được wrap bởi app.jsp decorator
    (SiteMesh) Server List Panel đã có sẵn trong decorator, chỉ cần Channel Sidebar + Main Content + Members Sidebar
    --%>
    ...
    <head>
      ...
      <link rel="stylesheet" href="${pageContext.request.contextPath}/css/voice-channel.css"
        data-cococord-page-style="1" />
      <link rel="stylesheet" href="${pageContext.request.contextPath}/css/voice-pip.css" data-cococord-page-style="1" />
      <link rel="stylesheet" href="${pageContext.request.contextPath}/css/markdown.css" data-cococord-page-style="1" />
      ...
      <link rel="stylesheet" href="${pageContext.request.contextPath}/css/chat-input.css"
        data-cococord-page-style="1" />
      <link rel="stylesheet" href="${pageContext.request.contextPath}/css/header-toolbar.css"
        data-cococord-page-style="1" />
      <link rel="stylesheet" href="${pageContext.request.contextPath}/css/server-settings.css"
        data-cococord-page-style="1" />
    </head>
    ...
    <div class="chat-page-container" id="chatApp">
      ...
      <aside class="channel-sidebar" aria-label="Channels">
        ...
        <div class="voice-connected-bar" id="voiceConnectedBar">
          <div class="voice-connected-info">
            ...
            <button class="voice-disconnect-btn" id="voiceBarDisconnect" title="Ngắt kết nối">
      ...
      <div class="channel-resizer" id="channelResizer" role="separator" aria-orientation="vertical"
        aria-label="Resize channel list"></div>
        ...
        <div class="text-channel-view" id="textChannelView">
          ...
          <div class="content-body" id="messageList" aria-label="Messages">
            ...
            <div class="welcome-message" id="chatEmpty">
              ...
              <div class="server-onboarding" id="serverOnboardingState" style="display: none">
                <h2 class="server-onboarding-title">
                  Chào mừng đến với<br /><span id="welcomeServerName">Máy chủ của bạn</span>
                </h2>
                <p class="server-onboarding-subtitle">
                  ...
                  <a href="#" class="server-onboarding-link" id="onboardingGettingStartedLink">hướng dẫn Bắt Đầu.</a>
                </p>
                <div class="server-onboarding-actions" role="list" aria-label="Onboarding actions">
                  <button type="button" class="server-onboarding-action" id="onboardingInviteBtn">
                    <span class="action-left">
                      <span class="action-icon" aria-hidden="true"><i class="bi bi-person-plus"></i></span>
                      <span class="action-text">Mời bạn bè của bạn</span>
                    </span>
                    <i class="bi bi-chevron-right" aria-hidden="true"></i>
                  </button>
                  <button type="button" class="server-onboarding-action" id="onboardingPersonalizeBtn">
                    <span class="action-left">
                      <span class="action-icon" aria-hidden="true"><i class="bi bi-brush"></i></span>
                      <span class="action-text">Cá nhân hóa máy chủ bằng một biểu tượng</span>
                    </span>
                    <i class="bi bi-chevron-right" aria-hidden="true"></i>
                  </button>
                  <button type="button" class="server-onboarding-action" id="onboardingFirstMessageBtn">
                    <span class="action-left">
                      <span class="action-icon" aria-hidden="true"><i class="bi bi-send"></i></span>
                      <span class="action-text">Gửi tin nhắn đầu tiên</span>
                    </span>
                    <i class="bi bi-chevron-right" aria-hidden="true"></i>
                  </button>
                  <button type="button" class="server-onboarding-action" id="onboardingDownloadBtn"
                    aria-disabled="true">
                    <span class="action-left">
                      <span class="action-icon" aria-hidden="true"><i class="bi bi-download"></i></span>
                      <span class="action-text">Tải xuống Ứng Dụng Discord</span>
                    </span>
                    <i class="bi bi-check-circle-fill" aria-hidden="true"></i>
                  </button>
                  <button type="button" class="server-onboarding-action" id="onboardingAddAppBtn">
                    <span class="action-left">
                      <span class="action-icon" aria-hidden="true"><i class="bi bi-controller"></i></span>
                      <span class="action-text">Thêm ứng dụng đầu tiên của bạn</span>
                    </span>
                    <i class="bi bi-chevron-right" aria-hidden="true"></i>
                  </button>
                </div>
        ...
        <div class="voice-channel-view" id="voiceChannelView">
          <div class="voice-channel-header">
            ...
            <div class="voice-channel-actions">
              <button class="voice-channel-action-btn" id="voiceBtnMinimize" title="Thu nhỏ (PIP)"
          ...
          <div class="voice-bottom-controls">
            <button class="voice-btn voice-btn-mute" id="voiceBtnMute" data-tooltip="Tắt tiếng">
              <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
                <path
                  d="M12 14c1.66 0 3-1.34 3-3V5c0-1.66-1.34-3-3-3S9 3.34 9 5v6c0 1.66 1.34 3 3 3zm-1-9c0-.55.45-1 1-1s1 .45 1 1v6c0 .55-.45 1-1 1s-1-.45-1-1V5zm6 6c0 2.76-2.24 5-5 5s-5-2.24-5-5H5c0 3.53 2.61 6.43 6 6.92V21h2v-3.08c3.39-.49 6-3.39 6-6.92h-2z" />
              </svg>
            </button>
            <button class="voice-btn voice-btn-deafen" id="voiceBtnDeafen" data-tooltip="Tắt nghe">
              <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
                <path
                  d="M12 1c-4.97 0-9 4.03-9 9v7c0 1.66 1.34 3 3 3h3v-8H5v-2c0-3.87 3.13-7 7-7s7 3.13 7 7v2h-4v8h3c1.66 0 3-1.34 3-3v-7c0-4.97-4.03-9-9-9z" />
              </svg>
            ...
            <button class="voice-btn voice-btn-camera" id="voiceBtnCamera" data-tooltip="Bật Camera">
              <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
                <path
            ...
            <button class="voice-btn voice-btn-screen" id="voiceBtnScreen" data-tooltip="Chia sẻ màn hình">
              <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
                <path
            ...
            <button class="voice-btn voice-btn-disconnect" id="voiceBtnDisconnect" data-tooltip="Rời phòng">
              <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
                <path
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="channel-type-selector">
            ...
            <label class="channel-type-option" data-type="FORUM">
              <i class="bi bi-chat-square-text"></i>
              <div>
                <strong>Diễn đàn</strong>
                <span>Đăng bài viết với hình ảnh, phản hồi bằng emoji</span>
              </div>
            </label>
          </div>
          <div class="form-group">
    ...
    <div class="user-settings-dropdown" id="userSettingsDropdown" style="display: none">
      <a href="${pageContext.request.contextPath}/sessions" class="dropdown-item"><i class="bi bi-shield-lock"></i>
        Phiên đăng nhập</a>
      <a href="${pageContext.request.contextPath}/change-password" class="dropdown-item"><i class="bi bi-key"></i> Đổi
        mật khẩu</a>
      <div class="dropdown-divider"></div>
