...
<%-- 
    Chat Page - Được wrap bởi app.jsp decorator (SiteMesh)
    Server List Panel đã có sẵn trong decorator, chỉ cần Channel Sidebar + Main Content + Members Sidebar
--%>
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/voice-channel.css" data-cococord-page-style="1">
</head>
            ...
            <div class="voice-connected-info">
                <div class="voice-connected-status">
                    <div class="voice-connected-label">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 1.5C6.753 1.5 2.5 5.753 2.5 11c0 2.243.79 4.303 2.1 5.922L3.5 21.5l5.025-1.587C9.628 20.43 10.782 20.5 12 20.5c5.247 0 9.5-4.253 9.5-9.5S17.247 1.5 12 1.5z"/></svg>
                        Đã Kết Nối Giọng Nói
                    </div>
                    <div class="voice-connected-channel">
                        <span id="voiceChannelName">Kênh thoại</span> / <span id="voiceServerName">Máy chủ</span>
                    </div>
                </div>
        ...
        <div class="content-body" id="messageList" aria-label="Messages">
            <div class="welcome-message" id="chatEmpty">
                ...
                <div class="server-onboarding" id="serverOnboardingState" style="display:none;">
                    <h2 class="server-onboarding-title">Chào mừng đến với<br><span id="welcomeServerName">Máy chủ của bạn</span></h2>
                    <p class="server-onboarding-subtitle">
                        Đây là máy chủ mới toanh của bạn. Sau đây là một vài bước để giúp bạn làm quen!
                        Để tìm hiểu thêm, vui lòng tìm đọc <a href="#" class="server-onboarding-link" id="onboardingGettingStartedLink">hướng dẫn Bắt Đầu.</a>
                    </p>
                    <div class="server-onboarding-actions" role="list" aria-label="Onboarding actions">
                        ...
                        <button type="button" class="server-onboarding-action" id="onboardingDownloadBtn" aria-disabled="true">
                            <span class="action-left">
