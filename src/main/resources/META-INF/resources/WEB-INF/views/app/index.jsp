...
<div class="cococord-home" id="cococordHome">
  ...
  <aside class="primary-sidebar" aria-label="Primary Sidebar">
    ...
    <div class="dm-list" id="dmList" role="list" aria-label="Direct Messages">
  ...
  <main class="main-area" aria-label="Main Content">
    ...
    <header class="top-bar">
      ...
      <div class="top-right">
        <!-- CoCo Credits Badge -->
        <div
          class="coco-credits-badge"
          id="cocoCreditsHeader"
          title="CoCo Credits"
        >
          <i class="bi bi-coin"></i>
          <span class="credits-amount" id="headerCreditsAmount">0</span>
        </div>
      ...
      <section class="content" id="friendsList">
        <div id="friendsListSkeleton" class="skeleton-friends-list">
          <div class="skeleton-friend-item">
            ...
            <div style="flex: 1">
              <div
                class="skeleton skeleton-text w-60"
                style="margin-bottom: 4px"
              ></div>
              <div
                class="skeleton skeleton-text w-40"
                style="height: 12px"
              ></div>
            </div>
          </div>
          <div class="skeleton-friend-item">
            ...
            <div style="flex: 1">
              <div
                class="skeleton skeleton-text w-80"
                style="margin-bottom: 4px"
              ></div>
              <div
                class="skeleton skeleton-text w-60"
          ...
          <div class="skeleton-friend-item">
            ...
            <div style="flex: 1">
              <div
                class="skeleton skeleton-text w-full"
                style="margin-bottom: 4px"
              ></div>
              <div
                class="skeleton skeleton-text w-40"
      ...
      <div class="nitro-container">
        <div class="nitro-hero">
          ...
          <div class="nitro-hero-content">
            ...
            <p>
              Nitro giúp bạn nổi bật với hồ sơ độc đáo, upload file lớn hơn,
              emoji HD và nhiều hơn nữa!
            </p>
          </div>
        </div>
    ...
    >
      <div class="shop-container">
        ...
        <div class="shop-tabs">
          <button class="shop-tab active" data-shop-tab="decorations">
            Trang trí Avatar
          </button>
          <button class="shop-tab" data-shop-tab="effects">
            Hiệu ứng Hồ sơ
          </button>
            ...
            <div class="shop-item">
              ...
              <div class="item-info">
                ...
                <span class="item-price"
                  ><i class="bi bi-lightning-charge-fill"></i> Nitro</span
                >
              </div>
            </div>
            <div class="shop-item">
        ...
        <div class="quests-list">
          ...
          <div class="quest-card" data-quest-id="1">
            <div class="quest-game-icon">
              <img
                src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Crect fill='%23ff6b35' width='24' height='24' rx='4'/%3E%3Cpath fill='white' d='M12 6L6 18h12z'/%3E%3C/svg%3E"
                alt="Game"
              />
            </div>
            <div class="quest-info">
              <div class="quest-header">
                ...
                <span class="quest-reward"
                  ><i class="bi bi-gift"></i> Avatar Decoration</span
                >
              </div>
              <p class="quest-description">
                Chơi bất kỳ chế độ nào trong Valorant trong 15 phút
              </p>
              ...
              <div class="quest-meta">
                <span class="quest-time"
                  ><i class="bi bi-clock"></i> Còn 2 ngày</span
                >
          ...
          <div class="quest-card" data-quest-id="2">
            <div class="quest-game-icon">
              <img
                src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Crect fill='%2300d4aa' width='24' height='24' rx='4'/%3E%3Ccircle fill='white' cx='12' cy='12' r='6'/%3E%3C/svg%3E"
                alt="Game"
              />
            </div>
            <div class="quest-info">
              <div class="quest-header">
                ...
                <span class="quest-reward"
                  ><i class="bi bi-gift"></i> 1 tháng Nitro Basic</span
                >
              </div>
              <p class="quest-description">
                Stream bất kỳ game nào cho bạn bè xem trong 30 phút
              </p>
              <div class="quest-progress">
                <div class="progress-bar">
              ...
              <div class="quest-meta">
                <span class="quest-time"
                  ><i class="bi bi-clock"></i> Còn 5 ngày</span
                >
          ...
          <div class="quest-card" data-quest-id="3">
            <div class="quest-game-icon">
              <img
                src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Crect fill='%23845ef7' width='24' height='24' rx='4'/%3E%3Cpath fill='white' d='M8 8h8v8H8z'/%3E%3C/svg%3E"
                alt="Game"
              />
            </div>
            <div class="quest-info">
              <div class="quest-header">
                ...
                <span class="quest-reward"
                  ><i class="bi bi-gift"></i> Profile Effect</span
                >
              </div>
              <p class="quest-description">
                Chơi và hoàn thành 3 ván Battle Royale trong Fortnite
              </p>
              <div class="quest-progress">
                <div class="progress-bar">
              ...
              <div class="quest-meta">
                <span class="quest-time"
                  ><i class="bi bi-clock"></i> Còn 7 ngày</span
                >
          ...
          <div class="quest-card completed" data-quest-id="4">
            <div class="quest-game-icon">
              <img
                src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Crect fill='%2340c057' width='24' height='24' rx='4'/%3E%3Cpath fill='white' d='M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4z'/%3E%3C/svg%3E"
                alt="Completed"
              />
            </div>
            <div class="quest-info">
              <div class="quest-header">
                ...
                <span class="quest-reward claimed"
                  ><i class="bi bi-check-circle"></i> Đã nhận</span
                >
              </div>
              <p class="quest-description">
                Gửi 50 tin nhắn trong bất kỳ server nào
              </p>
              <div class="quest-progress">
                <div class="progress-bar">
              ...
              <div class="quest-meta">
                <span class="quest-completed"
                  ><i class="bi bi-check-circle-fill"></i> Hoàn thành</span
                >
              </div>
            </div>
          </div>
